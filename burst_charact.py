...
N3t_data = read_model_burst(path+N3t,scale=100)
...
plt.subplot(1,3,3)
plot_corr(period,N3t_interv[DUR],"Period (s)","Duration of "+N3t +" (s)",ran,False)


plt.savefig("./results_invariant_tests/images/"+path[:-1]+".png")
# plt.show()
